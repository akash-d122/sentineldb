...
Uses a sync psycopg2 connection for migrations (Alembic runs synchronously).
The runtime application uses the asyncpg URL defined in Settings.DATABASE_URL.
"""
...
def _sync_url(async_url: str) -> str:
    """Convert asyncpg URL to psycopg2 URL for Alembic sync migrations."""
